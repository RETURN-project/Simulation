...
```{r}
ifolder <- '../Data/char' #'C:\\Users\\keers001\\OneDrive\ -\ WageningenUR\\RETURN\\Data\\RETURN\\20191019_SimulationOptSAR\\Landsat\\Char\\'  # folder with data characteristics
...
Vnyr <- c(10,20)#seq(6,40,6)# number of years
VdistMag <- -c(0.1,0.5)#-seq(0.1,0.5,0.1)# magnitude disturbance
VdistT <- c(5,15) #seq(3,18,3)# timing disturbance
VdistRec <- c(3,10)*STnobsYr#seq(3,15,2)*STnobsYr# recovery disturbance
