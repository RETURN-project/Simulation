...
# results_list <- evalParam(1, sttngs, pars, funSet, basename, ofolder)
results_list <- lapply(1:length(sttngs$general$eval), FUN = evalParam, sttngs = sttngs, pars = pars, funSet = funSet, basename = basename, ofolder = ofolder)
