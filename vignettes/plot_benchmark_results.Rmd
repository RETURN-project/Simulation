...
# inputs
# input folder
ifolder <- '/home/wanda/Documents/data/benchmarkRecovery/Run_20201016_linRecPeriod/'#'../data/'#ifolder <- '/home/wanda/Documents/data/benchmarkRecovery/Run_20201005_4steps/'#'../data/'#ifolder <- '/home/wanda/Documents/data/benchmarkRecovery/Run_20201005_4steps/'
# Folder where outputs will be written
ofolder <- '/home/wanda/Documents/data/benchmarkRecovery/Run_20201016_linRecPeriod/Figures/'#'../data/'#ofolder <-'/home/wanda/Documents/data/benchmarkRecovery/Run_20201005_4steps/Figures'#'../data/' #ofolder <- '/home/wanda/Documents/data/benchmarkRecovery/Run_20201005_4steps/Figures'
...
for(mm in 1: length(metric_list)){
  ...
  data$Smooth <- revalue(factor(data$Smooth, levels = c('raw', 'smoothed', 'segmented')), c("raw"="no", "smoothed"="rolling mean", "segmented" = "piecewise regression"))
  xlbl <- simFullName[pp]
  ylbl <- metric_names[[metric]]
  scales = 'free_y'
