...
```{r load-data}
# user inputs
# input folder - folder where sampled time series are located
ifolder <- '../data/'
# Folder where outputs will be written
ofolder <- '../data/'
# Name of the input dataset
basename <- 'LSTS_RndmSample_NoFire_5_Tree_80_scl_30_npnt_20000_VI' 
# Time series parameters that are evaluated. SeasAmp stands for seasonal amplitude; remSD for noise magnitude; 
# distT for timing of the disturbance; distRec for recovery half time; missVal for missing values; distMag for disturbance magnitude
caseList <- c('seasAmp','remSd','distT','distRec','missVal','distMag')#
