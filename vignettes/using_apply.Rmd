...
In the present vignette I show a simple case study of using apply functions in this kind of problems (plus the not-always-easy vectorization).
...
The four functions below do the same, and only differ in the way the input row is specified:
...
# Analyze (vectorized)
# Vectorizing the input is often complicated, but in this case is possible. I leave here the example
vanalyze <- function(row) {
  
  # Auxiliary function. 
  # Returns 2 for Belgium and -2 for The Netherlands in a vectorized way
  country_to_number <- function(country) {
